...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <form role="form" action="/admin/users/<?php echo htmlspecialchars( $user["id_usuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/password" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="senha-confirm" name="senha-confirm" placeholder="Confirme a nova senha">
            </div>
          </div>
          <!-- /.box-body -->
